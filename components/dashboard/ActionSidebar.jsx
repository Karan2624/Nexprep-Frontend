  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white/70 backdrop-blur-xl border border-white/60 rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.03)] flex flex-col max-h-[420px]">
        <div className="px-4 sm:px-6 py-4 sm:py-5 border-b border-white/60 bg-white/40 flex items-center justify-between shrink-0">
      ...
      {/* UPDATES */}
      <div className="bg-white/70 backdrop-blur-xl border border-white/60 rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.03)] flex flex-col max-h-[420px]">
        <div className="px-4 sm:px-6 py-4 sm:py-5 border-b border-white/60 bg-white/40 flex items-center gap-2 shrink-0">
