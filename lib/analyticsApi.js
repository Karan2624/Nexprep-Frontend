...
export async function fetchAnalyticsData() {
  try {
    ...
    const [lcRec, lcWeak, cfProf, lcProfileStats, cfProfileStats] = await Promise.all([
      api.get("/recommendations/leetcode").then(res => res.data.data).catch(() => null),
      api.get("/recommendations/leetcode/weakspots").then(res => res.data.data).catch(() => null),
      api.get("/recommendations/codeforces/profile").then(res => res.data.data).catch(() => null),
      api.get("/leetcodeStat").then(res => res.data.data).catch(() => null),
      api.get("/codeforcesStat/me").then(res => res.data.data).catch(() => null),
    ]);
